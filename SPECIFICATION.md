...
- No public/anonymous access. No student-facing accounts — students never log in; they only
  ever see the printed/exported "student report" PDF, distributed by the instructor through
  whatever channel is normal in the department (out of scope here).
